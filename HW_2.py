...
print('14. Квадратный корень из числа ' + str(item_1) + ' = ' + str(result_s_root))
...
print('16. Квадратный корень из числа ' + str(item_2) + ' = ' + str(result_m_s_root))
...
print('18. Квадратный корень =', result_mp_s_root)
...
print('22. Result =', result_division)
...
print('24. Result =', result_m_floor)
...
print('30. Result =', result_no_division_loss)
...
print('32. Result =', result_division_loss)
...
print('51. Result =', b_item_result_sum)
...
print('53. Result =', b_item_result_subtr)
...
print('55. Result =', b_item_result_multi)
