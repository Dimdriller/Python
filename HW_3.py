...
# то вывести в консоль (“Переменная item_1 меньше”, comp_item), иначе, вывести в консоль (“Переменная item_1 больше или равна”, comp_item)
if item_1 < comp_item:
    print('24. Переменная item_1 меньше, comp_item')
else:
    print('24. Переменная item_1 больше или равна, comp_item')
...
if item_2:
    ...
    print('25_else. Переменная item_2 = ', item_3)
...
if item_3:
    ...
    print('26_else. Переменная item_3 = ', item_3)
...
if item_5:
    ...
    print('27_else. Переменная item_5 = ', item_4)
...
if item_4:
    ...
    print('28_else. Переменная item_4 = ', item_4)
